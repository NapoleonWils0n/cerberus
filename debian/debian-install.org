...
#+begin_src sh
doas apt install abook aria2 bc curl dconf-editor ffmpeg fd-find git gnome-tweaks gufw handbrake imagemagick kodi \
kodi-inputstream-adaptive libsox-fmt-all mpd mpc mpv mpv-mpris ncmpc oathtool obs-studio openvpn pandoc pinentry-curses \
