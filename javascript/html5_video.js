$(function() { 
 if ($.browser.msie && $.browser.version <= 8 ){
	...
	var poster = $('video').attr('poster');
	 var flash = $('<embed type="application/x-shockwave-flash" src="http://192.168.1.4/~djwilcox/dev/css/player.swf" width="640" height="270" allowscriptaccess="always" allowfullscreen="true" wmode="transparent" /></embed>').attr('flashvars', 'file='+videoSrc+'&image='+poster+'&stretching=fill');
