...
prepend gnome-session-inhibit before mpv in the Exec line
...
add the following code snippet to your ~/.zshenv
...
create an alias with mpv that run gnome-session-inhibit
