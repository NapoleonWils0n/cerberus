...
#+begin_src sh
podman run -d --name searxng --network searxng --volume /home/djwilcox/podman/searxng:/etc/searxng:rw -p 8080:8080 --env SEARXNG_BASE_URL=http://127.0.0.1:8080 --env SEARXNG_REDIS_URL=redis://redis:6379/0 docker.io/searxng/searxng:latest
#+end_src
...
when you need to start searxng run
