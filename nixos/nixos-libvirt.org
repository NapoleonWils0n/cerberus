...
Virtio-fs requires the guest to have a shared memory region with the host.

Open Virt-Manager and open your Windows 11 VM settings (lightbulb icon).

Go to Memory on the left.

Check the box Enable shared memory.

Click Apply.

**** Add the Filesystem Hardware
...
#+begin_src sh
mkdir -p ~/libvirt/share/
#+end_src

Source Path: Browse to the folder on your host you want to share (e.g., ~/libvirt/share).

Target Path: Give it a simple tag like hostshare. You will need this name later.

Click Finish.

**** Install the Driver in Windows 11

Windows won't see this folder until the service is running.

Install WinFSP: Download and install the WinFSP package from winfsp.dev. This acts as the filesystem "bridge."

[[https://winfsp.dev/]]

VirtIO Drivers: If you haven't already, run the virtio-win-guest-tools.exe from your VirtIO ISO. Ensure Virtio-FS is selected.
...
A new drive should appear in This PC. If it doesn't, map it manually:

Open File Explorer.

Right-click This PC > Map network drive.

Drive: Z: (or any letter).
...
<domain type='kvm' id='1'>
  ...
  <devices>
    ...
    <disk type='file' device='disk'>
      ...
      <source file='/home/djwilcox/libvirt/images/win11.qcow2' index='3'/>
      <backingStore/>
    ...
    <disk type='file' device='cdrom'>
      ...
      <source file='/home/djwilcox/libvirt/images/win11.iso' index='2'/>
      <backingStore/>
    ...
    <disk type='file' device='cdrom'>
      <driver name='qemu' type='raw'/>
      <source file='/home/djwilcox/libvirt/images/virtio-win.iso' index='1'/>
      <backingStore/>
    ...
    <filesystem type='mount' accessmode='passthrough'>
      ...
      <binary path='/nix/store/z2fds29in360bsx7323wpndh1i96ps37-virtiofsd-1.13.3/bin/virtiofsd'/>
      <source dir='/home/djwilcox/libvirt/share'/>
    ...
    <interface type='network'>
      ...
      <source network='default' portid='3f02acd6-b802-471b-b2a6-5bcd6a1f6acc' bridge='virbr0'/>
      <target dev='vnet0'/>
      <model type='virtio'/>
      <alias name='net0'/>
...
Spice guest tools for copy and paste from host to the vm

you can get the official spice-guest-tools-latest.exe directly from the Spice project.

https://www.spice-space.org/download/windows/spice-guest-tools/spice-guest-tools-latest.exe

** Start the Network Manually

Run these two commands to get the network running and set it to start automatically every time you boot NixOS:
...
** Important mount the zfs directory

if you havent set the zfs filesystem mount in your configuration.nix you have manually mount the directory

#+begin_src sh
doas zfs mount zpool/home/libvirt
#+end_src
...
<domain xmlns:qemu="http://libvirt.org/schemas/domain/qemu/1.0" type="kvm">
  ...
  <os>
    ...
    <loader readonly="yes" type="pflash" format="raw">/home/djwilcox/libvirt/OSX-KVM/OVMF_CODE_4M.fd</loader>
    <nvram format="raw">/home/djwilcox/libvirt/OSX-KVM/OVMF_VARS-1920x1080.fd</nvram>
  </os>
  <features>
    <acpi/>
    <apic/>
  ...
  <devices>
    ...
    <disk type="file" device="disk">
      <driver name="qemu" type="qcow2" cache="writeback" io="threads"/>
      <source file="/home/djwilcox/libvirt/OSX-KVM/mac_hdd_ng.img"/>
      <target dev="sdb" bus="sata"/>
      <address type="drive" controller="0" bus="0" target="0" unit="1"/>
    </disk>
    <disk type="file" device="disk">
  ...
  <qemu:commandline>
    ...
    <qemu:arg value="-cpu"/>
    <qemu:arg value="host,vendor=GenuineIntel,+hypervisor,+invtsc,kvm=on,+fma,+avx,+avx2,+aes,+ssse3,+sse4_2,+popcnt"/>
  </qemu:commandline>
</domain>
#+end_src
