...
#+begin_src sh
doas poudriere ports -d -p local
#+end_src

download the new quarterly branch

#+BEGIN_SRC sh
doas poudriere ports -c -p local -m git+https -B 2026Q3
#+END_SRC
...
** uninstall Nvidia drivers and install pkg version
