...
*** Unload the active driver modules

If you are currently running your desktop environment, drop to a TTY or stop your display manager

Unload the active kernel modules so they aren't locked during deletion:

#+begin_src sh
doas kldunload nvidia-modeset nvidia-drm nvidia
#+end_src
