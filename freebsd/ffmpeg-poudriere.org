...
#+begin_src sh
ffmpeg-8.1,1              Realtime audio/video encoder/converter and streaming server
#+end_src

install ffmpeg

#+begin_src sh
doas pkg install ffmpeg-8.1,1
#+end_src
...
#+begin_src sh
doas bectl create 14.2-ffmpeg
#+end_src

**** activate the new boot env

#+begin_src sh
doas bectl activate 14.2-ffmpeg
#+end_src
...
boot into the new bectl boot env and log in at the tty
