...
Switch back to the base branch and pull updates

#+begin_src sh
doas git checkout 2026Q2
doas git pull
#+end_src
...
# 2. Switch back to your official quarterly branch

#+begin_src sh
doas git checkout 2026Q2
#+end_src

# 3. Delete the custom ardour branch safely
