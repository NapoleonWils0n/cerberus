...
Copy the lunar script to the debootstrap scripts directory

#+begin_src sh
sudo cp lunar /usr/local/share/debootstrap/scripts
#+end_src

Copy the mantic script to the debootstrap scripts directory

#+begin_src sh
sudo cp mantic /usr/local/share/debootstrap/scripts
#+end_src
