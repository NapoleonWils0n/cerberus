...
make without xwayland and match and let the compiler optimize specifically for your hardware.

#+begin_src sh
gmake CC=cc CFLAGS+='-std=c11 -march=native'
#+end_src

install

#+begin_src sh
doas install -m 755 dwl /usr/local/bin/
#+end_src
