...
** whisperx usage
*** diarize and highlight words

#+begin_src sh
whisperx input.wav --device cuda --model small --diarize --highlight_words True --language en --compute_type float32
#+end_src

*** dont diarize and highlight words

#+begin_src sh
whisperx input.wav --device cuda --model small --language en --compute_type float32
#+end_src

*** only create a vtt file

#+begin_src sh
whisperx input.wav --device cuda --model small --language en --output_format vtt --compute_type float32
#+end_src
...
#+begin_src sh
whisperx input.wav --device cuda --model small --diarize --highlight_words True --language en --min_speakers 3 --max_speakers 3 --compute_type float32
#+end_src

** whisperx json

#+begin_src sh
whisperx --language en input.mp4 --device cuda --model small --diarize --highlight_words True --output_format json,srt --compute_type float32
#+end_src
