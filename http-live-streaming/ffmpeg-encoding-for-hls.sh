...
-bsf:v h264_mp4toannexb -b:v 4750k -bufsize 1835k \
-vf "yadif=0:-1:0, scale=1280:trunc(ow/a/2)*2" \
-threads 0 -pix_fmt yuv420p -flags -global_header \
-x264opts keyint=250:min-keyint=25 \
-pass 1 -an \
-f mp4 720p-high.mp4
...
-bsf:v h264_mp4toannexb -b:v 2500k -bufsize 1835k \
