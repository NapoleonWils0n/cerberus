...
services:
  ...
  n8n:
    ...
    restart: always
    # check your id on the command line by running id
    # and change user: "1000:100" below to match the id
    user: "1000:100" 
    environment:
      - DB_TYPE=postgresdb
    ...
    volumes:
      ...
      # ADD THIS BIND MOUNT: Maps the local folder './data' (where your compose file is)
      # to the container path '/local_files'. This is your workflow output folder.
      - ./data:/local_files 
    depends_on:
      postgres:
