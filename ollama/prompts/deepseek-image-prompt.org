...
2) using the output text fields from the first step for each character write a several hundred word description of the data as a scene, as if it was a photograph. i want you 
