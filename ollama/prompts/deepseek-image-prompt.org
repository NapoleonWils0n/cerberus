...
2 - and then write additional detailed sentences on their own line for each of the text fields listed in the output format using the examples provided as well as your training for each character
