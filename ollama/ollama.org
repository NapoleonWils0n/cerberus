...
# Limit GPU layers to keep 1GB VRAM free for your NixOS desktop
PARAMETER num_gpu 20
# Cap context to 8192 to prevent slow-down as the chat gets long
...
#+begin_src sh
ollama create deepseek-coder-v2-gpu-20 -f deepseek-coder-v2-custom.modelfile
#+end_src

***** run the custom model

#+begin_src sh
ollama run deepseek-coder-v2-gpu-20
#+end_src
