...
#+begin_src sh
ffplay input.mp4 -vf "delogo=x=10:y=10:w=200:h=200:show=0,delogo=x=1400:y=20:w=500:h=480"
#+end_src
...
#+begin_src sh
ffplay input.mp4 -vf "delogo=x=10:y=10:w=200:h=200:show=0:enable='between(t,0,10)',delogo=x=1400:y=20:w=500:h=480:show=0:enable='between(t,0,10)'"
#+end_src
