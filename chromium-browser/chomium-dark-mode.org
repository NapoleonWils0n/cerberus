...
enable dark mode on chromium in 3 steps

** enable global gtk dark theme

+ step 1

edit your gtk 3 settings file or create it if it doesnt exist

#+begin_src sh
vi ~/.config/gtk-3.0/settings.ini
#+end_src

set your dark theme, icons and set gtk to prefer a dark theme
...
** chromium setting appearance

+ step 2

open chroimum settings/appearance

#+begin_example
chrome://settings/appearance
#+end_example

click Theme GTK+ to enable the gtk theme in chroimum

** enable chromium flags for dark mode

+ step 3

enable chromium flags for dark mode support

*** chromium-flags.conf

+ option 1

create the ~/.config/chromium-flags.conf file if it doesnt exist

#+begin_src sh
vi ~/.config/chromium-flags.conf
#+end_src

add the following chroimum flags to the chromium-flags.conf file
...
if that doesnt work you can try adding those options to a chromium.desktop file as explained below

*** chromium non snap desktop file

+ option 2

if you are not using the snap version of chromium you can copy the chromium-browser.desktop 
to ~/.local/share/applications and modify the file to append the chromium flags to the exec lines

#+begin_src sh
cp /usr/share/applications/chromium-browser.desktop ~/.local/share/applications
#+end_src

edit the ~/.local/share/applications/chromium-browser.desktop file 

#+begin_src sh
vi ~/.local/share/applications/chromium-browser.desktop
#+end_src

change the exec lines to add --force-dark-mode --enable-features=WebUIDarkMode
...
Exec=chromium-browser --force-dark-mode --enable-features=WebUIDarkMode %U
Terminal=false
...
Name[zh_CN]=打开新窗口
Name[zh_TW]=開啟新視窗
Exec=chromium-browser --force-dark-mode --enable-features=WebUIDarkMode
...
Exec=chromium-browser --incognito --force-dark-mode --enable-features=WebUIDarkMode
...
Exec=chromium-browser --temp-profile --force-dark-mode --enable-features=WebUIDarkMode
#+end_example

*** chromium snap desktop file

+ option 2

if you are using the snap version of chromium you can copy the chromium_chromium.desktop 
to ~/.local/share/applications and modify the file to append the chromium flags to the exec lines
...
edit the ~/.local/share/applications/chromium_chromium.desktop file 

#+begin_src sh
vi ~/.local/share/applications/chromium_chromium.desktop
#+end_src
