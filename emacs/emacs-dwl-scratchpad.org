...
"scratchpad"
(interactive)
(with-selected-frame (make-frame '((name . "scratchpad")
;;(minibuffer . only)
(minibuffer . only)
...
static const Key keys[] = {
	...
	{ MODKEY,                    XKB_KEY_p,          spawn,          {.v = scratchpad} },
...
emacsclient -cF "((visibility . nil))" -e "(scratchpad)" 
#+end_src
